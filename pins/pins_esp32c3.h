...
// DAC output (TX) - ESP32-C3 has no built-in DAC, use PWM or I2S
...
#define PIN_YSF         GPIO_NUM_18    // YSF mode LED
#define PIN_P25         GPIO_NUM_19    // P25 mode LED
#define PIN_NXDN        GPIO_NUM_20    // NXDN mode LED
#define PIN_POCSAG      GPIO_NUM_21    // POCSAG mode LED
#define PIN_M17         GPIO_NUM_10    // M17 mode LED
#define PIN_FM          GPIO_NUM_2     // FM mode LED
#endif

// ESP32-C3 specific settings
#define ESP32C3_ADC_BITS    12         // 12-bit ADC resolution
#define ESP32C3_ADC_SAMPLES 1          // No hardware averaging

// Buffer sizes (smaller due to limited RAM)
#define ESP32C3_RX_BUFFER_SIZE  256
#define ESP32C3_TX_BUFFER_SIZE  256
...
// ESP32-C3 only has LOW_SPEED_MODE (no HIGH_SPEED_MODE)
#define PWM_FREQUENCY       78125      // 78.125kHz PWM carrier
#define PWM_RESOLUTION      12         // 12-bit resolution (0-4095)
#define PWM_CHANNEL         LEDC_CHANNEL_0
#define PWM_SPEED_MODE      LEDC_LOW_SPEED_MODE  // Only LOW_SPEED on C3
